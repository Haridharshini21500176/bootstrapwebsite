...
<body>
    ...
    <div class="row">
        <div class="col mt-3 mb-3" style="background-color:#83b6c5">
            ...
            <a class="rounded float-end mt-1 mb-1 ms-1 me-1" href="https://www.youtube.com/channel/UCN2fiHd5IFWtNyu-vpAkeEA/videos" target="_blank"> 
                <img src=".\images\pas.png" alt="PoliceAurSeva" style="width:150PX; height:30px;">
            </a>
        </div>
    </div>
        ...
        <li class="nav-item">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="Evolution.html">Evolution Of BPR&D</a></li>
    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#5c8585;">
        <div class="row">
            <div class="col-sm-3 mt-2">
                <ul class="nav nav-tabs nav-justified" style="background-color:#dfa1a1; font-size:larger;">
                    <li class="nav-item">
                ...
                <div class="container-fluid rounded bg-light p-2 mt-2 mb-2" >
                    <div class="container rounded mt-2 mb-2 border" style="background-color:  #99f1ea; font-size:larger;">
            ...
            <div class="col-sm-6 mt-2">
                ...
                <div id="demo" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src=".\images\npm1.jpg" alt="npm1" class="rounded d-block w-100">
                        </div>
                        <div class="carousel-item">
                            <img src=".\images\npm2.jpg" alt="npm2" class="rounded d-block w-100">
                        </div>
                        <div class="carousel-item">
                            <img src=".\images\npm3.jpg" alt="npm3" class="rounded d-block w-100">
                        </div>
                    </div>
                ...
                <div class="container-fluid rounded bg-light mt-2 mb-2 p-2">
                    ...
                    <div class="container rounded mt-2 mb-2 border" style="background-color:#afdfee;">
                        <div class="container mt-2">
            ...
            <div class="col-sm-3 mt-2">
                <div class="container-fluid rounded bg-light mt-2 mb-2 p-2">
                    <div class="container-fluid bg-light text-black text-center mt-3 mb-3">
                        <img src=".\images\balaji.jpg" class="img-fluid rounded" style="width:100%; height:400px;" alt="Balaji ips">
                    </div>
                    <h6 style="text-align: center;">"Good Policing cannot be perceived without t....</h6><br>
                    <a href="general.html" class="link-primary float-end">&#8649;View more</a><br>
                    ...
                    <div class="container-fluid rounded mt-2 mb-2 p-2" style="background-color: #c58e8e;">
        ...
        <footer id="footer">
            <div class="container-fluid text-center rounded bg-light p-2">
                ...
                <div class="credits">
                     by <a href="https://bootstrapmade.com/">Haridharshini.S</a>
                </div>
            </div>
        </footer>
    </div>
...
<body>
    ...
    <div class="row">
        <div class="col mt-3 mb-3" style="background-color:#bee8f5">
            <!-- ======= Left Side icons ======= -->
            <a class="rounded-circle float-start mt-1 mb-1"  href="https://twitter.com/bprdindia?lang=en" target="_blank">
                <img src=".\images\twitter.jpg" style="width:30px;height:30px" alt="Twitter">
            </a>
            ...
            <!-- ======= Right Side icons ======= -->
            <a class="rounded float-end mt-1 mb-1 ms-1 me-1" href="https://bprd.nic.in/WriteReadData/News/BureauDarpan.pdf" target="_blank"> 
                <img src=".\images\durapan.png" alt="BureauDarpan" style="width:150px; height:30px;">
            </a>
            <a class="rounded float-end ms-1 me-1" href="https://rashtragaan.in/" target="_blank"> 
                <img src=".\images\azadi.png" alt="SingtheNationalAnthem"  style="width:150PX; height:30px;">
            </a>
    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#85fafa;">
        <div class="row">
            <div class="col-sm mt-2 mb-2 me-2 ms-2 text-center">
                <table class="table text-center">
                    <thead>
                      <tr>
                        <th style="font-size: larger;">Evolution of the Bureau of Police Research and Development</th>
                      </tr>
                    </thead>
                </table>
                <table class="table text-center">
                    <thead>
                        <tr>
                            <th style="font-size:medium; font:  sans-serif;"><strong>CREATION</strong><br>
                ...
                <table class="table text-center">
                    <thead>
                        <tr>
                            <th style="font-size:medium; font:caption;"><strong>SEPARATION</strong><br>
...
<body>
    ...
    <ul class="nav nav-tabs nav-justified">
        <li class="nav-item">
          <a class="nav-link active" href="Home.html">Home > G_DMessage</a>
        </li>
        <li class="nav-item">
            <div class="dropdown">
                <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown">
    ...
    <div class="container-fluid mt-2 mb-2 ms-2 me-2" style="background-color:#ccffff;">
        <div class="row">
            <div class="col-sm-5 mt-2 mb-2">
                <img src=".\images\balaji.jpg" class="img rounded float-end" style="width:150px; height:200px;" alt="BPR&D">
            </div>
            <div class="col-sm-6 mt-2 mb-2 me-2">
                <table class="table">
                    <thead>
                      <tr>
                        <th style="font-size: larger;">Message from Director General-Balaji Srinivas IPS</th>
                      </tr>
                    </thead>
                </table>
                <table class="table">
